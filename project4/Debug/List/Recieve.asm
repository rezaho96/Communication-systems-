...
; 0000 0010             Tempreture1 = SPDR;
	IN   R30,0xF
	LDI  R26,LOW(_Tempreture1)
	LDI  R27,HIGH(_Tempreture1)
	CALL SUBOPT_0x0
...
; 0000 0012             Tempreture2 = SPDR;
	IN   R30,0xF
	LDI  R26,LOW(_Tempreture2)
	LDI  R27,HIGH(_Tempreture2)
	CALL SUBOPT_0x0
; 0000 0013         T = (Tempreture1+Tempreture2)/2;
_0x4:
	LDS  R30,_Tempreture2
	LDS  R31,_Tempreture2+1
	LDS  R22,_Tempreture2+2
	LDS  R23,_Tempreture2+3
	LDS  R26,_Tempreture1
	LDS  R27,_Tempreture1+1
	LDS  R24,_Tempreture1+2
	LDS  R25,_Tempreture1+3
	CALL __ADDF12
	MOVW R26,R30
	MOVW R24,R22
	__GETD1N 0x40000000
