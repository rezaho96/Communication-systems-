...
_0x0:
	.DB  0x54,0x65,0x6D,0x70,0x72,0x65,0x74,0x75
	.DB  0x72,0x65,0x20,0x3D,0x20,0x0
_0x2000060:
	.DB  0x1
_0x2000000:
...
; 0000 0020 PORTB.4=1;
	SBI  0x18,4
; 0000 0021 
; 0000 0022 //ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
; 0000 0023 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0024 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
; 0000 0027 
; 0000 0028 
; 0000 0029 Tempreture = read_adc(0)/2.058;
	CALL SUBOPT_0x0
	CALL SUBOPT_0x1
; 0000 002A 
; 0000 002B while (1){
...
_0xB:
	...
	LDS  R24,_Tempreture+2
	LDS  R25,_Tempreture+3
	CALL __CPD12
	BREQ _0xD
...
; 0000 0038     lcd_clear();
	CALL _lcd_clear
; 0000 0039     lcd_puts("Tempreture = ");
	__POINTW2MN _0x18,0
	CALL _lcd_puts
; 0000 003A     ftoa(T,0,str);
	CALL SUBOPT_0x2
	CALL __PUTPARD1
	LDI  R30,LOW(0)
	ST   -Y,R30
...
SUBOPT_0x1:
	...
	STS  _Tempreture+2,R22
	STS  _Tempreture+3,R23
	RET
